...
import logo from './Home/remiixlogo.png';
    ...
    render() {
        return (
            <div className="App">
                ...
                <div className="home-subscribe-text">
                    <input className="home-subscribe-input" placeholder="Email Address"></input>
                    <button className="home-submit">Submit</button>
                </div>
                <div className="home-svgdiv">
                    <svg width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 1659 1365" version="1.1">
                        ...
                        <g id="Canvas" transform="translate(-3002 -730)">
                            ...
                            <g id="Group">
                                ...
                                <g id="Rectangle 8" className="verticalline">
                                    <use href="#path7_fill" transform="matrix(5.33596e-17 -1 1 7.02666e-17 3002 1850)"
                                         fill="#9B51E0"/>
                                </g>
                                <g id="Rectangle 8" className="verticalline">
                                    <use href="#path8_fill"
                                ...
                                <g id="Rectangle 8" className="verticalline">
                                    <use href="#path9_fill" transform="matrix(5.33596e-17 -1 1 7.02666e-17 3002 1910)"
                                         fill="#2E8CE6"/>
                                </g>
                                <g id="Rectangle 8" className="verticalline">
                                ...
                                <g id="Rectangle 8" className="verticalline">
                                    <use href="#path13_fill" transform="matrix(6.12323e-17 -1 1 6.12323e-17 3002 1507)"
                                         fill="#2E8CE6"/>
                                </g>
                                <g id="Rectangle 8" className="verticalline">
                                    <use href="#path13_fill" transform="matrix(6.12323e-17 -1 1 6.12323e-17 3002 1539)"
                                         fill="#F9FF70"/>
                                </g>
                                <g id="Rectangle 8" className="verticalline">
                                    <use href="#path13_fill" transform="matrix(6.12323e-17 -1 1 6.12323e-17 3002 1572)"
                                         fill="#ABFE59"/>
                                </g>
                                <g id="Rectangle 8" className="verticalline">
                ...
                <div className="home-options">
                    ...
                    <img className="option-1" src={reality} width="200" height="200"></img>
                    <img className="option-2" src={wrdz} width="200" height="200"></img>
                    <img className="option-3" src={concepts} width="200" height="200"></img>
                    <img className="option-4" src={tunez} width="200" height="200"></img>
                ...
                <div className="home-nav"> <a> Home</a> | <a> About</a> | <a> Contact</a> </div>
