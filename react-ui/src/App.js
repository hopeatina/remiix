...
class App extends Component {
    // createText() {
    //     Text = React.createElement( <div className="home-subscribe-text">
    ...
    render() {
        let Trid = null;
        Trid = <div className="home-subscribe-text">
            Get dope weekly updates
        </div>;

        const About = <div className="home-aboutcard">About <div className="home-aboutgrad"></div></div>;
        const Contact = <div className="home-aboutcard">Contact<div className="home-aboutgrad"></div></div>;
        const Home = <div>
        ...
        return (
            <BrowserRouter>
                <div className="App">
                    ...
                    <Route exact={true} path="/" component={() => Trid}/>
                    ...
                    <div className="home-nav"><Link to={'/'}> Home</Link> | <Link to={'/about'}> About</Link> | <Link
