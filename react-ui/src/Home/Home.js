    ...
    render() {
        ...
        const Home = <div>
            ...
            <div className="home-options">
                ...
                <Link to="/reality"><img className="option-1" src={reality} width="200" height="200"></img></Link>
                <Link to="/wrdz"><img className="option-2" src={wrdz} width="200" height="200"></img></Link>
                <Link to="/concepts"><img className="option-3" src={concepts} width="200" height="200"></img></Link>
                <Link to="/tunez"><img className="option-4" src={tunez} width="200" height="200"></img></Link>
        ...
        return (
            <div className="App">
                ...
                <Route exact={true} path="/home" component={() => Subtext}/>
                ...
                <div className="home-nav"><Link to={'/home'}> Home</Link> | <Link to={'/home/about'}> About</Link> | <Link
                    to={'/home/contact'}> Contact</Link></div>
            </div>
        );
    }
}
